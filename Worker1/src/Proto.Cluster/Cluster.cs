...
namespace Proto.Cluster
{
    ...
    public class Cluster : IActorSystemExtension<Cluster>
    {
        ...
        public Task<T> RequestAsync<T>(string identity, string kind, object message, CancellationToken ct, string tick) =>
            ClusterContext.RequestAsync<T>(new ClusterIdentity {Identity = identity, Kind = kind}, message, System.Root, ct, tick);

        public Task<T> RequestAsync<T>(string identity, string kind, object message, ISenderContext context, CancellationToken ct, string tick) =>
            ClusterContext.RequestAsync<T>(new ClusterIdentity {Identity = identity, Kind = kind}, message, context, ct, tick);
